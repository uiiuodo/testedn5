              ...
              child: AbsorbPointer(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Obx(
                      () => Column(
                        children: List.generate(
                          controller.anniversaries.length,
                          (index) {
                    ...
                    Obx(
                      () => Column(
                        children: List.generate(controller.memos.length, (
                          index,
                        ) {
                    ...
                    Obx(() {
                      ...
                      for (var p in controller.preferences) {
                        if (!grouped.containsKey(p.title))
                          grouped[p.title] = [];
                      ...
                      return Column(
                        children: grouped.entries.map((entry) {
                          ...
                          final isExpanded = controller.expandedCategories
                              .contains(category);
